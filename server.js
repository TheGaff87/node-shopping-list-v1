...
//add demo items to Recipes
Recipes.create('buddha bowl', ['brown rice', 'avocado', 'chicken' ]);
Recipes.create('nachos', ['tortilla chips', 'shredded mexican cheese']);
...
//create endpoint to retrieve Recipes list
